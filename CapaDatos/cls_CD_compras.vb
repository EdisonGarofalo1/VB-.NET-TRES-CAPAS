...
Public Class cls_CD_compras
    Public g_str_fecha_salida As String = "dd/MM/yyyy"
    Dim id_cabezera As Long = 0
    Function fun_CD_recuperar_cabezera(ByVal num As String) As cls_CE_facturas
        Try
    ...
    Function fun_CD_recuperar_detalles(ByVal nun_doc As String) As List(Of cls_CE_detalleFactura)
        Try
            ...
            If dr.HasRows Then
                While dr.Read
                    Dim obj As New cls_CE_detalleFactura
                    With obj
    ...
    End Function
    Function fun_CD_recuperar_usuario(ByVal nun_doc As String) As cls_CE_clientes
        Try
            fun_CD_recuperar_usuario = Nothing
            Dim str_cadenaSql As String
        ...
        End Try
    End Function
    Function cls_CD_cargarproducto(ByVal buscar As String) As List(Of cls_CE_producto)
        Try
            Dim str_cadenaSql As String = ""
    ...
    Function fun_CD_Grabar(ByVal lista_1 As cls_CE_facturas, ByVal lista_2 As List(Of cls_CE_detalleFactura)) As Boolean
        Try
            fun_CD_Grabar = False
            ...
            If fun_grabar_cabezera(lista_1) = False Then
                ...
                Exit Function
            End If
            If fun_recuperar_cabezera(lista_1.CABMOV_NUM_DOC) = False Then
                funRollbacktrans()
                Exit Function
            End If
    ...
    Function fun_grabar_detalles(ByVal lista_2 As List(Of cls_CE_detalleFactura)) As Boolean
        Try
            ...
            For i = 0 To lista_2.Count - 1
                ...
                str_cadenasql = str_cadenasql & " UPDATE PRODUCTOS set  STOCK=STOCK + " & lista_2(i).DET_CANTIDAD & " where  PRO_ID= " & lista_2(i).CAT_ID & ""
    ...
    Function fun_grabar_cabezera(ByVal lista_1 As cls_CE_facturas) As Boolean
        Try
            ...
            str_cadenasql = str_cadenasql & lista_1.CABMOV_NUM_DOC & " , "
            str_cadenasql = str_cadenasql & 1 & " , '"
                str_cadenasql = str_cadenasql & "ING' , "
            str_cadenasql = str_cadenasql & lista_1.PER_ID & " , '"
            str_cadenasql = str_cadenasql & Format(Date.Now, g_str_fecha_salida) & "'  , "
            str_cadenasql = str_cadenasql & lista_1.CABMOV_BASE_IMPONIBLE & " , "
            str_cadenasql = str_cadenasql & lista_1.CABMOV_IVA & " , "
            str_cadenasql = str_cadenasql & lista_1.CABMOV_VALOR_FINAL & " , "
            str_cadenasql = str_cadenasql & " 'A' , "
            str_cadenasql = str_cadenasql & lista_1.USUARIO & " , '"
            str_cadenasql = str_cadenasql & Format(Date.Now, g_str_fecha_salida) & "' , '"
                str_cadenasql = str_cadenasql & Format(Date.Now, g_str_fecha_salida) & "' ) "
            '//Next
